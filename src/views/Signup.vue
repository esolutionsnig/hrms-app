            ...
            <v-card-text>
              ...
              <v-form>
                ...
                <div class="errors ml-4" v-if="errors.surname">
                    <small class="error--text" :key="error" v-for="error in errors.surname">{{ error }}</small>
                </div>
                <v-text-field
                  prepend-icon="person"
                  name="firstname"
                ...
                <div class="errors ml-4" v-if="errors.firstname">
                    <small class="error--text" :key="error" v-for="error in errors.firstname">{{ error }}</small>
                </div>
                <v-text-field
                  prepend-icon="person"
                  name="othernames"
                ...
                <div class="errors ml-4" v-if="errors.othernames">
                    <small class="error--text" :key="error" v-for="error in errors.othernames">{{ error }}</small>
                </div>
                <v-text-field
                  prepend-icon="email"
                  name="email"
                ...
                <div class="errors ml-4" v-if="errors.password">
                    <small class="error--text" :key="error" v-for="error in errors.password">{{ error }}</small>
                </div>
                <v-text-field
                  prepend-icon="lock"
...
export default {
  ...
  methods: {
      registerUser() {
          this.loading = true
          console.log( this.surname, this.firstname, this.othernames, this.email, this.password, this.password_confirmation )
          ...
          .then((response) => {
              ...
              this.ss = true;
              this.ssMsg = "Dear " + this.surname + " " + this.firstname + ", Your registration was successful and we sent an email to this  ( " + this.email + " ) email address. Kindly click on the CONFIRM ACCOUNT button on the body of the mail received to complete this process.";
